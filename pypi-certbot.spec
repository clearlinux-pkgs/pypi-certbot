...
Source0  : https://files.pythonhosted.org/packages/00/91/a7acb7a9f7f065bf7f4aa356ecae039f229798eeceed205f397f329cd666/certbot-4.0.0.tar.gz
Summary  : ACME client
...
%prep
%setup -q -n certbot-4.0.0
cd %{_builddir}/certbot-4.0.0
pushd ..
cp -a certbot-4.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744120808
