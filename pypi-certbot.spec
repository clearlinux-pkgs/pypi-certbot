...
Source0  : https://files.pythonhosted.org/packages/16/8d/c4e226ef3fc95b478e4895837818c3fb54bfd91caf7366a31fa0f75b88a9/certbot-2.7.3.tar.gz
Summary  : ACME client
...
%prep
%setup -q -n certbot-2.7.3
cd %{_builddir}/certbot-2.7.3
pushd ..
cp -a certbot-2.7.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698259623
