...
Source0  : https://files.pythonhosted.org/packages/f3/f8/16e8d798f5ad191be67f7369c83ab9e51da9c35e4bcc310073c37dc4debe/certbot-2.9.0.tar.gz
Summary  : ACME client
...
%prep
%setup -q -n certbot-2.9.0
cd %{_builddir}/certbot-2.9.0
pushd ..
cp -a certbot-2.9.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707498028
