...
Source0  : https://files.pythonhosted.org/packages/d8/65/0a84f55afd6e245519f708f83cd43433bbe26986500cc6bdf6e309fd988e/certbot-2.7.2.tar.gz
Summary  : ACME client
...
%prep
%setup -q -n certbot-2.7.2
cd %{_builddir}/certbot-2.7.2
pushd ..
cp -a certbot-2.7.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697824707
