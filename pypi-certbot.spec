...
Source0  : https://files.pythonhosted.org/packages/83/18/0abe4ff4591f650a3a1604904019390f11b691f29863c16e725495e9b57a/certbot-1.31.0.tar.gz
Source1  : https://files.pythonhosted.org/packages/83/18/0abe4ff4591f650a3a1604904019390f11b691f29863c16e725495e9b57a/certbot-1.31.0.tar.gz.asc
Summary  : ACME client
...
%prep
%setup -q -n certbot-1.31.0
cd %{_builddir}/certbot-1.31.0
pushd ..
cp -a certbot-1.31.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665075807
