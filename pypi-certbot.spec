...
Source0  : https://files.pythonhosted.org/packages/d7/7e/5155b8a7837fb433acee0bfd87e950bab96ab7e02ece21cc9c7d3d5effc4/certbot-2.10.0.tar.gz
Summary  : ACME client
...
%prep
%setup -q -n certbot-2.10.0
cd %{_builddir}/certbot-2.10.0
pushd ..
cp -a certbot-2.10.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712243190
