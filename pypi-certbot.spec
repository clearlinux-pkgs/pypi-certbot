...
Source0  : https://files.pythonhosted.org/packages/8d/21/0cb5341289df917d5286aa4f79adeb844815b2ffa112067b2ab748bf107d/certbot-2.7.4.tar.gz
Summary  : ACME client
...
%prep
%setup -q -n certbot-2.7.4
cd %{_builddir}/certbot-2.7.4
pushd ..
cp -a certbot-2.7.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698880182
