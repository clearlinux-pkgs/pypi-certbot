...
Source0  : https://files.pythonhosted.org/packages/51/91/36333487ecdd801cc641bbf07f3e798f1cf715078a6fb64f3b46f715ab80/certbot-3.1.0.tar.gz
Summary  : ACME client
...
%prep
%setup -q -n certbot-3.1.0
cd %{_builddir}/certbot-3.1.0
pushd ..
cp -a certbot-3.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736349029
