...
Source0  : https://files.pythonhosted.org/packages/fe/bf/3ed9a042683141c4b3b53be492db5d2e7553ba59d0b8fb34cad2938df9b9/certbot-3.2.0.tar.gz
Summary  : ACME client
...
%prep
%setup -q -n certbot-3.2.0
cd %{_builddir}/certbot-3.2.0
pushd ..
cp -a certbot-3.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739341160
