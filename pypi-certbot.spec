...
Source0  : https://files.pythonhosted.org/packages/80/05/b67d31d2e339023be8e23133cf0de6c3a1389fa440a822872be219370cac/certbot-1.32.0.tar.gz
Summary  : ACME client
...
%prep
%setup -q -n certbot-1.32.0
cd %{_builddir}/certbot-1.32.0
pushd ..
cp -a certbot-1.32.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668009539
